                    ...
                    <tbody>
                        ...
                        @foreach ($data as $datas)
                            @php
                                ...
                                $paidAmount = ($invoice->total_amout_paid)/2;
                                $netInvoPrice = ((float) $invoice->net_price - ( (float) $invoice->discount + (float) $invoice->display_discount + (float) $invoice->special_discount + (float) $invoice->custom_discount ))/2;
                                $dueAmount1 = ((float) $netInvoPrice - (float) $paidAmount);
                                ...
                                @if ($invoice->invoice_status == 0 && $invoiceType == 1)
                                    ...
                                    @if ((int) $diff_in_days > (int) $customer->max_credit_bill_availability)
                                        <tr class="{{ $borderClass }}" style="background-color: #ffcdd2; color: #424242;">
                                            ...
                                            <td class="sumPricePaid" style="text-align: right; padding-right: 30px;">{{ number_format($paidAmount, 2) }}</td>
