 ...
 * @property UmUser $umUser
 */
class interfaceComponentHistory extends Model
{
    /**
     ...
     * @var array
     */
    protected $fillable = ['pm_interface_components_id', 'pm_user_role_id', 'um_user_id', 'created_by', 'created_date', 'interface_name', 'component_name', 'is_added', 'is_removed'];
